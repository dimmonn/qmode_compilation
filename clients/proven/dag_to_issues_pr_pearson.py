...
strategy_name = "pearson_spearman"  # Change as needed
...
analysis_strategy.visualize_correlation(data=data, features=features, targets=targets, results=correlation_results)
